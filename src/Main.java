...
public class Main {
    public static void main(String[] args) {
        ...
        Endereco enderecoRestauranteCami2 = new Endereco("123456", "Endereceo Restaurante Cami");
        Endereco enderecoRestauranteFulana = new Endereco("56646545", "Endereceo Restaurante Fulana");
